    ...
    <section class="content">
            ...
            <div class="card card-default">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <a href="#" data-toggle="modal" data-target="#store-modal" class="btn btn-sm bg-teal"><i
                                class="fas fa-list-alt"></i> {{ __('New General') }}</a>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-sm bg-teal" href="" data-toggle="modal"
                                                    data-target="#edit-modal" data-id="<?= $general->id ?>"
                                                    data-name="<?= $general->name ?>"
                                                    data-value="<?= $general->value ?>"><span
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title"> {{ __('New General') }} </h4>
                    </div>
                    <div class="modal-body">
                        <form action="{{ route('admin.generals.store') }}" method="post" enctype="multipart/form-data"
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-12">
                                        ...
                                        <input name="value" placeholder="{{ __('Value') }}" class="form-control"
                                            required="" type="text">
                                    </div>
                                </div>
                            </div>
        ...
        <div class="modal fade" id="edit-modal">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title"> {{ __('Update General') }} </h4>
                    </div>
                    <div class="modal-body">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <div class="col-sm-12">
                                        <label>{{ __('Name') }}</label>
                                        <input name="name" placeholder="{{ __('Name') }}" class="form-control"
                                            required="" type="text" id="name" readonly>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-12">
                            ...
                            <div class="col-md-12">
                                <center>
                                    <button data-dismiss="modal" aria-label="Close"
                                        class="btn btn-sm btn-danger">{{ __('Reset') }}</button>
