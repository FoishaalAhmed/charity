                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">{{ __('Volunteer List') }}</h3>
                            <div class="card-tools">
                                <a href="{{ route('admin.volunteers.create') }}" class="btn btn-sm bg-teal"><i
                                        class="fas fa-plus-square"></i> {{ __('Create Volunteer') }}</a>
                                    ...
                                    @foreach ($volunteers as $item)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <form action="{{ route('admin.volunteers.destroy', [$item->id]) }}"
