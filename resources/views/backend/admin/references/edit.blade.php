            ...
            <div class="card card-default">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <a href="{{ route('admin.references.index') }}" class="btn btn-sm bg-teal"><i
                                class="fas fa-list-alt"></i>
                            {{ __('Testimonial List') }}</a>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.references.update', $reference->id) }}" method="post" id="TeamForm"
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-12">
                                                ...
                                                <textarea id="summernote"
                                                    name="message"> {{ $reference->message }} </textarea>
                                            </div>
                                        </div>
                                        <!-- /.form-group -->
                                    </div>
                                    ...
                                    <div class="card-body box-profile">
                                        <div class="text-center">
                                            <img class="profile-user-img img-fluid img-circle"
                                                src="{{ asset($reference->photo) }}" alt="User profile picture"
                                                id="teamPhoto">
