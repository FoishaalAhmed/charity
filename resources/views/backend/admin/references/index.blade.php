                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                <a href="{{ route('admin.references.create') }}" class="btn btn-sm bg-teal"><i
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="width: 45%">{{ __('Message') }}</th>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-sm bg-blue"
                                                    href="{{ route('admin.references.edit', [$item->id]) }}"><span
                                                        class="fas fa-edit"></span></a>

                                                <form action="{{ route('admin.references.destroy', [$item->id]) }}"
