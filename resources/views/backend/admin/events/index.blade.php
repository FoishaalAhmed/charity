                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">{{ __('Event List') }}</h3>
                            <div class="card-tools">
                                <a href="{{ route('admin.events.create') }}" class="btn btn-sm bg-teal"><i
                                        class="fas fa-plus-square"></i> {{ __('Create Event') }}</a>
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="width: 25%">{{ __('Center') }}</th>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-sm bg-blue"
                                                    href="{{ route('admin.events.edit', [$item->id]) }}"><span
