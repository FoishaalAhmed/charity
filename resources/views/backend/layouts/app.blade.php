...
<body class="hold-transition sidebar-mini dark-mode @if (request()->is('admin/news')) {{ 'sidebar-collapse' }} @endif" <?php if (session()->has('message')) {
    echo "onload='setTimeout(snackbar_function, 100)';";
} ?>>
    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="{{ URL::to('/') }}" class="brand-link">
                <img src="{{ asset('public/images/logo.jpg') }}" alt="AdminLTE Logo"
                    class="brand-image img-circle elevation-3" style="opacity: .8">
                <span class="brand-text font-weight-light">Econ</span>
            </a>
        ...
        <footer class="main-footer">
            <strong>Copyright &copy; {{ date('Y') }} <a href="{{ URL::to('/') }}">Econ</a>.</strong>
            All rights reserved.
    ...
    <script src="{{ asset('public/backend/plugins/datatables-responsive/js/dataTables.responsive.min.js') }}">
    </script>
    <script src="{{ asset('public/backend/plugins/datatables-responsive/js/responsive.bootstrap4.min.js') }}">
    </script>
