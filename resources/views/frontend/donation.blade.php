                            ...
                            <form action="{{ route('donations.store') }}" method="post">
                                ...
                                <div class="row">
                                        ...
                                        <div class="form-group">
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="customRadioInline1" name="amount"
                                                    class="custom-control-input" value="10" checked>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <a href="#"><img
                                                    src="{{ asset('public/frontend/assets/images/paypal_btn.png') }}"
                                                    alt=""></a>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <p class="text-primary">This is simple a note to the donators regarding our
                                            services and policy.</p>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <select class="theme-combo donation-select select2" name="country"
                                                style="height: 400px">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 mt-3">
                                        <button class="btn btn-default" type="submit"><i data-feather="heart"></i> Donate
                                            Now</button>
                                    </div>
                                </div>
                            </form>
